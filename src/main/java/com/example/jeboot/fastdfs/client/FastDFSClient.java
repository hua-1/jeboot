package com.example.jeboot.fastdfs.client;
...
//        }
     ...
     * @return
     */
    public static FileResponseData getFileNameInfo(String fileId) {
        if (StringUtils.isNotEmpty(fileId)) {
            ...
            if (pos > 0 && pos != fileId.length() - 1) {
                ...
                responseData.setFilePath(group+FastDFSClient.SEPARATOR);
